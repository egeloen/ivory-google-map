...
class SourceRendererTest extends TestCase
{
    ...
    {
        $this->assertSame(
            'function name(src){var script=document.createElement("script");script.type="text/javascript";script.crossorigin="anonymous";script.defer;script.src=src;document.getElementsByTagName("head")[0].appendChild(script);};',
    ...
    {
        $this->assertSame(
            'function name(source){var variable=document.createElement("script");variable.type="text/javascript";variable.crossorigin="anonymous";variable.defer;variable.src=source;document.getElementsByTagName("head")[0].appendChild(variable);};',
