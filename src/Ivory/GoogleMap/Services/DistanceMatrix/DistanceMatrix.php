...
class DistanceMatrix extends AbstractService
{
    ...
    {
        parent::__construct('http://maps.googleapis.com/maps/api/distancematrix');
    }
    ...
    public function process()
    {
        ...
        $distanceMatrixResponse = $this->buildDistanceMatrixResponse($this->parse($response->getContent()));
    ...
    protected function buildDistanceMatrixResponse(\stdClass $distanceMatrixResponse)
    {
        ...
        return new DistanceMatrixResponse($destinations, $origins, $rows, $status);
    }
    ...
    protected function buildDistanceMatrixResponseElement($element)
    {
        ...
        if (DistanceMatrixElementStatus::OK === $element->status) {
        ...
        return new DistanceMatrixResponseElement($distance, $duration, $status);
    }
}
