...
class DistanceMatrixResponse
{
     ...
     *
     * @param array $destinations The normalizwd destinations.
     * @param array $origins The normalized origins.
     * @param array $rows The rows of data returned.
     * @param string $status The response status.
     */
    public function __construct(array $destinations, array $origins, array $rows, $status)
    {
    ...
    {
        if (!in_array($status, DistanceMatrixStatus::getDistanceMatrixStatuses())) {
