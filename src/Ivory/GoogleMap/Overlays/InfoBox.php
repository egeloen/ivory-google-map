...
/**
 * Info box which describes a google map info box.
 *
 * @author Radu Topala <radu.topala@trisoft.ro>
 */
class InfoBox extends AbstractOptionsAsset implements ExtendableInterface
{
    /** @var string */
    protected $content;
    ...
    public function __construct(
        ...
        $this->setPrefixJavascriptVariable('info_box_');
